...
const className = {
  filled:
    "flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black border-indigo-500 items-center rounded-lg bg-indigo-700 py-2 px-4 text-white duration-150 hover:bg-indigo-800 disabled:bg-indigo-600",
  outline:
  ...
  secondery:
    "flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black items-center rounded-lg bg-emerald-800 py-2 px-4 text-white duration-150 hover:bg-emerald-900 disabled:bg-emerald-700",
};
