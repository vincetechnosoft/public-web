...
export default function CareersForm() {
    ...
    const onSubmit = useCallback(function (e: FormEvent<HTMLFormElement>) {
        ...
        if (!fullName) {
            ...
            if (a.length !== 2 || !a[0] || !a[1]) {
                error.fullName = 'Format: "FirstName<space>LastName"';
            }
        }
        ...
        if (!cv) {
            ...
            error.cv = "File must be in .pdf format";
        ...
        if (portfolio) {
            if (portfolio.size / (1024 * 1024) > 5) {
                ...
                error.portfolio = "File must be in .pdf format";
            }
        }
    ...
    return (
        ...
        >
            ...
            {success ? (
                <Message type="success" title="Form Submitted Successfully">
