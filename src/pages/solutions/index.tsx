        ...
        <HomeLayout>
            ...
            <div className="min-h-[100vh] py-10">
                <h1 className="mx-5 mb-10 flex items-center text-4xl underline-offset-2 hover:underline md:mx-24">
                    ...
                    <Link href={{pathname: "/solutions", hash: "distributors-solution"}}>
            ...
            >
                {softwareData.map(({title, content}, i) => (
                    <div key={i} className="card">
                        <div
                            className="flex justify-center rounded-t-lg bg-accent2 px-2 pt-3 pb-1 -text-accent2 lg:h-24 xl:h-auto">
