...
const data = [
    {
        title: "INTRODUCTION",
        content: [
            "Vince Technosoft respects the privacy of our users. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website vincetechnosoft.com, including any other media form, media channel or mobile website related or connected thereto. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.",
    ...
    },
    {
        title: "PERSONAL DATA",
        content: [
            "Personally, identifiable information, such as your name, email gender, hometown, and interests, that you voluntarily give to us when you register with the Site when you choose to participate in various activities related to the Site, such as online chat and message boards. You are under no obligation to provide us with personal information of any kind, however, your refusal to do so may prevent you from using certain features of the Site.",
        ],
    },
    {
    ...
    },
    {
        ...
        content: [
            [
                "The Site may by default access your ",
                "Facebook",
                "basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to make public. We may also request access to other permissions related to your account, such as friends, check-ins, and likes, and you may choose to grant or deny us access to each individual permission. For more information regarding Facebook permissions, refer to the",
    ...
    {
        title: "DATA FROM OUR CONTESTS, GIVEAWAYS, AND SURVEYS",
        content: [
    ...
    },
    {
        ...
        content: [
            [
                ...
                "[Adobe Analytics,] [Clicktale,] [Clicky,] [Cloudfare,] [Crazy Egg,] [Flurry Analytics,] [Google Analytics,] [Heap Analytics,] [Inspectlet,/strong`>`] [Kissmetrics,] [Mixpanel,] [Piwik,]",
