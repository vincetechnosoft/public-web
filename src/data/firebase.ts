...
function init() {
    ...
    initializeAppCheck(app, {
        provider: new ReCaptchaV3Provider("6LeGJIUgAAAAAJsCxpFuraQLeovfTVvP3HBJtSfP"),
...
const _onCareersFormSubmit = httpsCallable<{ [key in keyof CareersFormData]: string },
    void>(functions, "PUBLICcareers");
export const _onContactUsFormSubmit = httpsCallable<{ [key in keyof ContactUsFormData]: string },
    void>(functions, "PUBLICcontactUs");
